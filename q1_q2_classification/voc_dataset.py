...
class VOCDataset(Dataset):
    ...
    def preload_anno(self):
        ...
        for index in self.index_list:
            ...
            for obj in root.iter('object'):
                cls_name = obj[0].text
                weight = int(obj[3].text)
                idx = VOCDataset.get_class_index(cls_name)
                class_vec[idx] = 1
                if weight_vec[idx] == 0 and weight == 0:
                    weight_vec[idx] = 1
                elif weight == 1:
                    weight_vec[idx] = 0
    ...
    def get_random_augmentations(self):
        ...
        # transforms.RandomResizedCrop(224,scale=(0.9, 1), ratio = (0.8,1.1)),
